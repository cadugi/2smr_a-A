...
def descifrar_contraseña():
    contrasena_ingresada = input("Ingrese la contraseña para descifrar el archivo: ")
...
while True:
    opcion = input("¿Deseas generar una nueva contraseña (G), descifrar contraseña (D) o salir (S)? ").strip().lower()
    ...
    if opcion == "g":
        ...
        print("Opción no válida. Debes elegir 'G' para generar una nueva contraseña, 'D' para descifrar contraseña o 'S' para salir.")
